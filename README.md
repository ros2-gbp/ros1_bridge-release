...
## ros1_bridge (rolling) - 0.10.2-1

The packages in the `ros1_bridge` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ros1_bridge` on `Fri, 05 Nov 2021 20:03:25 -0000`
...
## ros1_bridge (dashing) - 0.7.9-1

The packages in the `ros1_bridge` repository were released into the `dashing` distro by running `/home/steven/osrf/bloom/.direnv/python-3.9.5/bin/bloom-release -r dashing ros1_bridge --override-release-repository-push-url git@github.com:ros2-gbp/ros1_bridge-release` on `Fri, 21 May 2021 16:16:35 -0000`
...
## ros1_bridge (rolling) - 0.10.1-1

The packages in the `ros1_bridge` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ros1_bridge` on `Mon, 25 Jan 2021 21:27:14 -0000`
...
## ros1_bridge (foxy) - 0.9.6-1

The packages in the `ros1_bridge` repository were released into the `foxy` distro by running `/Users/william/.pyenv/versions/3.8.0/bin/bloom-release -r foxy -t foxy ros1_bridge` on `Wed, 09 Dec 2020 22:44:53 -0000`
...
## ros1_bridge (rolling) - 0.10.0-1

The packages in the `ros1_bridge` repository were released into the `rolling` distro by running `/Users/william/.pyenv/versions/3.8.0/bin/bloom-release -r rolling -t rolling ros1_bridge` on `Wed, 09 Dec 2020 21:37:08 -0000`
...
## ros1_bridge (dashing) - 0.7.8-1

The packages in the `ros1_bridge` repository were released into the `dashing` distro by running `/Users/william/.pyenv/versions/3.8.0/bin/bloom-release -r dashing -t dashing ros1_bridge` on `Wed, 09 Dec 2020 18:44:27 -0000`
...
## ros1_bridge (eloquent) - 0.8.3-1

The packages in the `ros1_bridge` repository were released into the `eloquent` distro by running `/usr/bin/bloom-release -r eloquent ros1_bridge` on `Wed, 09 Dec 2020 18:35:52 -0000`
...
## ros1_bridge (dashing) - 0.7.6-3

The packages in the `ros1_bridge` repository were released into the `dashing` distro by running `/usr/bin/bloom-release -r dashing ros1_bridge` on `Mon, 21 Sep 2020 20:20:47 -0000`
